...
Enhancements
Now worls with doNOWHOLE which is a bias corrected with no whole number flagged data
...
# end
    :param bool doNOWHOLE: work on the bias corrected data with whole number flagged data removed
# KATE modified
