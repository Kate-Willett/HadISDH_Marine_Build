...
class test_sphere_distance(unittest.TestCase):
  ...
  def test_small_steps_latitude(self):
      ...
      self.assertAlmostEqual(6400.*np.pi/36,a,delta=0.00000001)
...
class test_lat_lon_from_course_and_distance(unittest.TestCase):
    ...
    def test_heading_north_from_pole_to_pole(self):
        ...
        lat,lon = lat_lon_from_course_and_distance(-90.0, 0.0, 0.0, np.pi*6400.)
    ...
    def test_heading_north_from_pole_to_pole_on_different_headings(self):
        ...
        for i in range(0,100):
            lat,lon = lat_lon_from_course_and_distance(-90.0, 0.0, i*360./100., np.pi*6400.)
            self.assertEqual(90.0, lat)

    def test_heading_east_round_equator(self):
        lat,lon = lat_lon_from_course_and_distance(0.0, 0.0, 90., 2*np.pi*6400.)
    ...
    def test_heading_eastish_round_equator(self):
        lat,lon = lat_lon_from_course_and_distance(0.0, 0.0, 45., np.pi*6400.)
        self.assertAlmostEqual(  0.0, lat,delta=0.00000001)
